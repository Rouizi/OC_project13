...
class CreateDealForm(forms.Form):
    ...
    phone_number = forms.CharField(label='Phone', validators=[
                                   phone_regex], max_length=17, required=False)
    ...
    def clean_mileage(self):
        # Return an error if mileage is negative
    ...
    def clean_price(self):
        # Return an error if price is negative
...
class ReservationDealForm(forms.ModelForm):
    ...
    def clean(self):
        # Return an error if check_in is greater than check_out
